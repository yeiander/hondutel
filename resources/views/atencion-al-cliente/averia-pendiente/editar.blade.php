            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            {{-- inicio --}}
                            <form action=" {{url('/atencion-al-cliente/averia-pendiente/'.$registro->id)}} " method="post">
                                @csrf
                                {{ method_field('PATCH')}}
                                <div class="container">
                                  <div class="row">
                                    ...
                                    <div class="col-sm">
                                      ...
                                      <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                           ...
                                           <input value ="aprobado" style="font-size:14px;" class="form-control" type="hidden" name="estadoAveria" id="estadoAveria">
                                         </div>
                                      </div>
                                     {{-- coloumna2 final --}}
                                    </div>
