                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm">
                                ...
                                <div class="col-xs-12 col--12">
                                  <div class="form-inline">
                                   <div class="form-group">
                                    <label id="clienteEstadoCivil"><h6>Numero de armario:</h6></label>
                                    <label id="clienteEstadoCivil"><h6 style="color: blue; margin-left:0.2rem;">  {{$registro->numerodearmario}} </h6></label>
                                   </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col--12">
                                    <div class="form-inline">
                                     <div class="form-group">
                                      <label id="clienteEstadoCivil"><h6>Caja terminal:</h6></label>
                                      <label id="clienteEstadoCivil"><h6 style="color: blue; margin-left:0.2rem;">  {{$registro->cajaterminal}} </h6></label>
                                     </div>
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-xs-12 col--12">
                                    <div class="form-inline">
                                     <div class="form-group">
                                      <label id="clienteEstadoCivil"><h6>Bornes:</h6></label>
                                      <label id="clienteEstadoCivil"><h6 style="color: blue; margin-left:0.2rem;">  {{$registro->bornes}} </h6></label>
                                     </div>
                                      </div>
                                  </div>
