...
@section('content')
    <section class="section">
        <div class="section-header" style="max-height: 3rem;">
            <h5 class="page__heading">Permiso personal pendientes</h5>
                            ...
                            <table  class="table table-striped table-bordered" style="width:100%" id="permiso1">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>{{$permiso->id}}</td>
                                    <td><a href="{{ url('/recursos-humanos-permisos/p-personal-pendiente/'.$permiso->id.'/edit') }}" class="btn btn-primary" type="button">Confirmar</a>
